  ...
  return (
    <section className="my-10">
      ...
      <div className="my-6 flex items-center">
        ...
        <span className="mx-4 text-xl font-semibold text-gray-900 text-center">
          {label}
        </span>
        <div className="flex-grow border-t border-gray-300"></div>
      </div>
      ...
      <div className="mt-4 flex justify-end">
        <button className="px-10 py-1 border border-[#9E9E9E] bg-[#E7EDF6] rounded text-gray-700 hover:bg-[#d9e4f0] transition">
          ADD
        </button>
      </div>
    </section>
