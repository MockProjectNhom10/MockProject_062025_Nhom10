...
function SideBar() {
  ...
  return (
    <>
      ...
      <div
        className={`bg-police fixed top-0 left-0 z-50 h-full rounded-r-xl p-4 text-white transition-all duration-300 ease-in-out ${collapsed ? "w-20" : "w-64"} ${mobileOpen ? "translate-x-0" : "-translate-x-full"} md:static md:flex md:translate-x-0 md:flex-col`}
      >
